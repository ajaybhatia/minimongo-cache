# @ajaybhatia/minimongo-cache

[![Dependency Status](https://david-dm.org/ajaybhatia/minimongo-cache/status.svg)](https://david-dm.org/ajaybhatia/minimongo-cache/status.svg)
...
```js
var minimongo = require('@ajaybhatia/minimongo-cache');
...
// Documents in `@ajaybhatia/minimongo-cache` have version numbers. They're very convenient
